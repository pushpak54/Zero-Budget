...
const VITE_SUPABASE_URL = process.env.REACT_APP_SUPABASE_URL || "https://ihlnfbxwymldllhiumsv.supabase.co";
const VITE_SUPABASE_ANON_KEY = process.env.REACT_APP_SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlobG5mYnh3eW1sZGxsaGl1bXN2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQ3ODA1OTMsImV4cCI6MjA5MDM1NjU5M30.z72IM971SEIgeXyIJojFAnl5sYGDJ0JMSiSifug0l00";
